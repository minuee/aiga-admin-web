...
export default function KeywordRankingList({ rankingData }: KeywordRankingListProps) {
  const textColor = useColorModeValue('secondaryGray.900', 'white');
  const brandButtonColor = useColorModeValue('brand.500', 'white'); // Moved outside conditional rendering
